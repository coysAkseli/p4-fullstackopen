...
describe('favorite blog', () => {
    test('of empty list returns the string "empty blog list"', () => {
        const result = listHelper.favoriteBlog(emptyBlogList);
        assert.strictEqual(result, "empty blog list");
    })
...
describe('most blogs', () => {
    test('of an empty list returns the string "no blogs"', () => {
        const result = listHelper.mostBlogs(emptyBlogList);
        assert.strictEqual(result, "no blogs");
    })

    test('of a list of one blog returns the author and 1 as the amount of blogs', () => {
...
describe('most likes', () => {
    ...
    test('of a list of of blog returns the author and likes for that blog', () => {
